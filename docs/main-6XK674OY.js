              ...
              ? ((t = r._injector ?? t),
                this.getChildConfig(t, r, o).pipe(
                  xe(({ routes: u }) => {
                    ...
                    let { segmentGroup: V, slicedSegments: U } = Hf(n, h, f, u);
                ...
                xe((u) => {
                  ...
                  if (
                    ...
                    let {
                      ...
                      U = new gr(h, this.urlSerializer.serialize(f), g, E);
                    this.events.next(U);
...
function hC(e, t) {
  e & 1 && (Yn(), m(0, "svg", 3), B(1, "path", 4), v());
}
function pC(e, t) {
  e & 1 && (Yn(), m(0, "svg", 5), B(1, "path", 6), v());
}
var di = class e {
  isDarkMode = !0;
  themeService = p(li);
  ...
  static ɵcmp = J({
    ...
    vars: 2,
    consts: [
      [1, "h-8", "w-8", "p-0.5", "rounded-lg", "hover:bg-gray-700", 3, "click"],
      [
        "class",
    ...
    template: function (n, r) {
      n & 1 &&
        ...
        Oe(1, hC, 2, 0, "svg", 1)(2, pC, 2, 0, "svg", 2),
        v()),
        n & 2 &&
