...
function nu(e, t, n, r, o, i, s, a) {
  let c = [], u = 0, l = 0, d = !1,
      ...
      f = E => u < r ? g(E) : c.push(E), g = E => {
        i && t.next(E), u++;
        let V = !1;
        K(n(E, l++)).subscribe(P(t, B => {o?.(B), i ? f(B) : t.next(B)},
                                 () => {V = !0}, void 0, () => {
                                   if (V)
                                     try {
                                       for (u--; c.length && u < r;) {
...
function U(e, t, n, r) { return m(e, t, n, r), v(), U }
...
function Ey(e, t, n, r, o, i, s) {
  ...
  if (r.type & 3 || s) {
    let E = Re(r, t), V = s ? s(E) : E, B = d.length,
  ...
  if (h && f !== null && (g = f[o])) {
    ...
    if (E)
      for (let V = 0; V < E; V += 2) {
        let B = g[V], Ie = g[V + 1], Vt = t[B][Ie].subscribe(i), be = d.length;
               ...
               c => c.matched
                        ? (t = r._injector ?? t,
                           this.getChildConfig(t, r, o).pipe(xe(({
                             ...
                             let Ie = ke(r) === i;
                             return this
                                 .processSegment(l, u, V, B, Ie ? x : i, !0, g)
  ...
  return e
    ...
    Hw = (() => {
      ...
      t.\u0275cmp = J({
        ...
        decls : 1,
        vars : 0,
        template : function(o, i) { o&1 && U(0, "router-outlet") },
        dependencies : [ YD ],
        encapsulation : 2
      });
      let e = t;
                       ...
                       return b(s).pipe(
                           xe(u => {
                             ...
                             if (l && this.urlHandlingStrategy.shouldProcessUrl(
                              ...
                              B = new gr(h, this.urlSerializer.serialize(f), g,
                                         E);
                               this.events.next(B);
...
var hC = (e, t) => ({hidden : e, flex : t}), li = class e {
  gradientColorClass =
  ...
  static \u0275cmp = J({
    ...
    consts:
        [
          ...
          [
            1, "hidden", "md:flex", "space-y-4", "md:space-y-0", "md:space-x-4",
            "font-semibold", "flex-col", "md:flex-row", "items-center",
            "md:items-center", "mt-4", "md:mt-0", 3, "ngClass"
          ],
          [
            "href", "#about", 1, "transition-transform", "duration-300",
            "ease-in-out", "hover:bg-gradient-to-r", "hover:from-purple-500",
            "hover:to-pink-500", "hover:bg-clip-text", "hover:text-transparent",
            "hover:border-b-2", "border-fuchsia-600"
          ],
          [
            "href", "#education", 1, "transition-transform", "duration-300",
            "ease-in-out", "hover:bg-gradient-to-r", "hover:from-purple-500",
            "hover:to-pink-500", "hover:bg-clip-text", "hover:text-transparent",
            "hover:border-b-2", "border-fuchsia-600"
          ],
          [
            "href", "#achievements", 1, "transition-transform", "duration-300",
            "ease-in-out", "hover:bg-gradient-to-r", "hover:from-purple-500",
            "hover:to-pink-500", "hover:bg-clip-text", "hover:text-transparent",
            "hover:border-b-2", "border-fuchsia-600"
          ],
          [
            "href", "#projects", 1, "transition-transform", "duration-300",
            "ease-in-out", "hover:bg-gradient-to-r", "hover:from-purple-500",
            "hover:to-pink-500", "hover:bg-clip-text", "hover:text-transparent",
            "hover:border-b-2", "border-fuchsia-600"
          ],
          [
            "href", "#research", 1, "transition-transform", "duration-300",
            "ease-in-out", "hover:bg-gradient-to-r", "hover:from-purple-500",
            "hover:to-pink-500", "hover:bg-clip-text", "hover:text-transparent",
            "hover:border-b-2", "border-fuchsia-600"
          ]
  ...
  static \u0275cmp = J({
    ...
    consts:
        [
          ...
          [
            "href", "https://linkedin.com/in/pranta-nath-nayan", 1,
          ...
          [
            "href", "https://github.com/prantanath", 1, "rounded-full",
          ...
          [
            "href", "mailto:prantanathnayan@gmail.com", 1, "rounded-full",
            "bg-transparent", "transition-transform", "duration-300",
          ...
          [
            ...
            "rounded-full", "bg-transparent", "transition-transform",
            "duration-300", "ease-in-out", "hover:bg-gray-300",
            "hover:shadow-[0_0_25px_rgba(236,72,153,1),_0_0_50px_rgba(236,72,153,1)]",
            "hover:text-blue-400"
          ],
    ...
    template:
        function(n, r) {
          n&1 && (m(0, "section", 0)(1, "div", 1)(2, "div", 2)(3, "div",
                  ...
                  U(23, "i", 11), v(), m(24, "a", 12), U(25, "i", 13), v(),
                  m(26, "a", 14), U(27, "i", 15), v(), m(28, "a", 16),
                  U(29, "i", 17), v()()(), m(30, "div", 18)(31, "div", 19),
                  U(32, "div", 20)(33, "img", 21), v()()()()()),
...
function gC(e, t) {
  if (e & 1 && (m(0, "div", 5)(1, "div", 6), S(2), v(), m(3, "p", 7), S(4), v(),
                ...
                S(10, "View Project"), v()(), U(11, "div", 11),
...
function mC(e, t) { e&1 && U(0, "div", 16) }
function vC(e, t) {
  if (e & 1 && (m(0, "div", 13)(1, "div", 14), S(2), v(),
                Oe(3, mC, 1, 0, "div", 15), v()),
      e & 2) {
    ...
    template:
        function(n, r) {
          n&1 && (m(0, "section", 0)(1, "div", 1)(2, "div", 2)(3, "span"),
                  ...
                  m(13, "div", 8), Oe(14, yC, 11, 5, "div", 9), v()()(),
                  m(15, "div", 10)(16, "a", 11), U(17, "img", 12), v()()()),
...
function wC(e, t) { e&1 && (Yn(), m(0, "svg", 3), U(1, "path", 4), v()) }
function CC(e, t) { e&1 && (Yn(), m(0, "svg", 5), U(1, "path", 6), v()) }
var vi = class e {
  isDarkMode = !1;
  themeService = p(mi);
  ngOnInit() {
  ...
  static \u0275cmp = J({
    ...
    consts:
        [
          [
            1, "fixed", "h-8", "w-8", "p-0.5", "rounded-l-lg",
            "hover:bg-gray-700", 3, "click"
          ],
          [
    ...
    template:
        function(n, r) {
          n&1 && (m(0, "button", 0),
                  ...
                  Oe(1, wC, 2, 0, "svg", 1)(2, CC, 2, 0, "svg", 2), v()),
...
var yi = class e {
  ...
  static \u0275cmp = J({
    ...
    consts:
        [
          [
            1, "bg-[#101010]", "font-space", "dark:bg-[#d0d3d4]",
            "dark:text-black"
          ],
          [ 1, "flex", "flex-row-reverse" ]
        ],
        ...
        function(n, r) {
          n&1 && (m(0, "div", 0),
                  U(1, "app-header")(2, "app-dark-mode", 1)(3, "app-about")(
                      4, "app-education")(5, "app-achievements")(
                      6, "app-projects")(7, "app-research"),
                  v())
        },
